			...
			>
				...
				>
					...
					<div>
						...
						We welcome interested people from all countries of the world to Join our website and get unlimited storage with fast speed.
						</h2>
					</div>

					<span>
						<p className=' text-gray-300 max-w-md'>
						NDrive is The most popular online cloud storage platform to use unlimited storage with low cost.
						</p>
					</span>
				</div>
				<div className='flex flex-row gap-5 flex-wrap earth '>
					...
					>
						...
						<p className='font-semibold text-gray-300 text-sm'>
							We have completed 50k+ member's.
						</p>
					</div>
